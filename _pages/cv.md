...
* Dec 2024 – Present: Lecturer, Dept. of Computer Science
  ...
  * Lead developer, in-department Web Development & Automation team — builds systems to digitize and automate departmental activities, including the student course registration system (open-credit model) and the admission management system

* Jan 2024 – Dec 2024: Software Engineer
  * Orion Informatics Ltd.
  * Full-stack systems (Spring Boot, Angular, MS SQL Server, Apache Kafka) for Equiniti US's shareholder/company management platform
  * Built a Kafka messaging pipeline handling millions of shareholder votes per hour
  * Improved reporting query performance by 60% across queries spanning hundreds of thousands of rows and tens of tables

* Jan 2022 – Dec 2023: Junior Software Engineer
  * Orion Informatics Ltd.
...
* Backend: Spring Boot, Angular, Node.js, Laravel, Nest.js, Apache Kafka
